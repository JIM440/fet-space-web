        ...
        <div className="container mx-auto p-4">
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row gap-6 items-center">
              <div className="bg-background-neutral w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden">
                <img
                  src="https://static.vecteezy.com/system/resources/thumbnails/059/514/138/small/empowered-man-smiling-in-classroom-setting-showcasing-confidence-and-engagement-free-photo.jpeg"
                  alt="Profile"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="text-center md:text-left">
                <ThemedText variant="h3">Njeck Dorothy Ambe</ThemedText>
            ...
            <div className="flex gap-4 flex-1">
              ...
              <ThemedText className="text-gray-600 dark:text-gray-400">
                njeckdorothy@ubuea.cm
              </ThemedText>
            </div>
            <div className="flex gap-4 flex-1">
              <ThemedText>Alternative Email:</ThemedText>
              <ThemedText className="text-gray-600 dark:text-gray-400">
                njeckdorothy@gmail.com
              </ThemedText>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex gap-4">
