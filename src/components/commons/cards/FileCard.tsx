...
const FileCard: React.FC<{ file: FileProps }> = ({ file }) => {
  ...
  const getIcon = (type: string) => {
    switch (type.toLowerCase()) {
      ...
      case "docx":
        return "../../../../src/assets/icons/docs.svg";
      case "img":
        return "../../../../src/assets/icons/img.svg";
      case "ppt":
        return "../../../../src/assets/icons/ppt.svg";
      case "video":
        return "../../../../src/assets/icons/img.svg";
      default:
  ...
  return (
    <>
      <div className="flex items-center gap-2 mt-2">
        ...
        >
          <ThemedText className="line-clamp-2 text-gray-100">
            {file.name}
          </ThemedText>
          <div className="flex gap-4 text-sm text-gray-400">
            ...
            {file.date && (
              <ThemedText variant="caption">{getTimeAgo(file.date)}</ThemedText>
            )}
          </div>
        </div>
